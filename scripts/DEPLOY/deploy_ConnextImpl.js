...
async function main () {
  ...
  // Impl Specific
  const CONNEXT_GATEWAY_ADDRESS = implData.GATEWAY_ADDRESS
  // Impl Specific
  ...
  const implContract = await upgrades.deployProxy(IMPL_CONTRACT, [CROSS_SYNC_GATEWAY_ADDRESS, CHAIN_NATIVE_CURRENCY_WRAPPED_ADDRESS, CHAIN_NATIVE_CURRENCY_ADDRESS, OWNER_ADDRESS, CONNEXT_GATEWAY_ADDRESS], { initializer: 'initialize', kind:'uups' })
