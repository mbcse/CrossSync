...
async function main () {
  ...
  // Impl Specific
  const CCIP_ROUTER_ADDRESS = implData.ROUTER_ADDRESS
  // Impl Specific
  ...
  const implContract = await upgrades.deployProxy(IMPL_CONTRACT, [CROSS_SYNC_GATEWAY_ADDRESS, CHAIN_NATIVE_CURRENCY_WRAPPED_ADDRESS, CHAIN_NATIVE_CURRENCY_ADDRESS, OWNER_ADDRESS, CCIP_ROUTER_ADDRESS], { initializer: 'initialize', kind:'uups' })
