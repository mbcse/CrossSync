...
async function main () {
  ...
  const implContract = await upgrades.deployProxy(IMPL_CONTRACT, [CROSS_SYNC_GATEWAY_ADDRESS, CHAIN_NATIVE_CURRENCY_WRAPPED_ADDRESS, CHAIN_NATIVE_CURRENCY_ADDRESS, OWNER_ADDRESS, TELEPORTER_ADDRESS], { initializer: 'initialize', kind:'uups' })
