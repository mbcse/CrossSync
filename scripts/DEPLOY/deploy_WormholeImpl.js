...
async function main () {
  ...
  // Impl Specific
  const WORMHOLE_RELAYER_ADDRESS = implData.RELAYER_ADDRESS
  // Impl Specific
  ...
  const implContract = await upgrades.deployProxy(IMPL_CONTRACT, [CROSS_SYNC_GATEWAY_ADDRESS, CHAIN_NATIVE_CURRENCY_WRAPPED_ADDRESS, CHAIN_NATIVE_CURRENCY_ADDRESS, OWNER_ADDRESS, WORMHOLE_RELAYER_ADDRESS], { initializer: 'initialize', kind:'uups' })
